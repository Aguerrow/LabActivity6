...
//Extract the title, genre, duration, cast properties from the movie with the id =5;
...
console.log(movieTitle, movieGenre, movieDescription);
...
const {
  title: movieTitle5,
  genre: movieGenre5,
  duration: movieDuration5,
  cast: movieCast5,
} = movie5;
console.log(movieTitle5, movieGenre5, movieDuration5, movieCast5);
...
//add another property - languages: English, Tagalog of the movie with id=6;
const movie6 = getMovie(6);
const updatedMovieLanguages = { ...movie6, languages: ["English", "Tagalog"] };
console.log(updatedMovieLanguages);
